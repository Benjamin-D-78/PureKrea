        ...
        if (auth)
            try {
                ...
                if (response.status === 200) {
                    setAuth((prevAuth) => {
                        const updatedAuth = { ...prevAuth, ...response.data };
                        localStorage.setItem("auth", JSON.stringify(updatedAuth)); // Mise à jour de localStorage
                        return updatedAuth;
                    });
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className={monProfil.contientDonnees}>
                                    ...
                                    <div className={monProfil.inputsProfil}>
                                        ...
                                        {/* "^" signifie : tout ce qui n'est pas compris entre... */}
                                        {/* "g" signifie que le remplacement doit se faire pour tous les caractères dans le texte, et pas juste pour la première correspondance. */}
                                        {/* Je convertis le texte en majuscule. */}
                                        {/* event.target.value fait référence à la valeur actuelle de l'élément du DOM qui a déclenché l'événement. */}
                                    </div>
                                </div>
